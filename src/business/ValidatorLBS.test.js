...
import {
  checkGroupBE,
  checkNameGroupBE,
  checkDescriptionGroupBE,
  checkStatusGroupBE,
  checkSelectionModeGroupBE,
  checkTypeGroupBE,
  checkProposedDateGroupBE,
  checkOpenedDateGroupBE,
  checkClosedDateGroupBE
} from './ValidatorLBS'
  ...
  describe('checkGroupBE', () => {
    it('Should not throw errors when the group is valid', () => {
      let groupBE = new GroupBE({
        ...
        status: GroupStatusEnum.PROPOSED,
        selectionMode: GroupSelectionModeEnum.RANDOM,
        type: GroupTypeEnum.PROJECT,
        proposedDate: '2019-06-01'
      })
      let err = () => {
